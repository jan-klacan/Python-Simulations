...
def main_cycle() :
    ...
    print("I added basic user input prompts and some parameters that will extend the scope of the simulation - you will be prompted to input values for these.")
    print("You can also skip filling in the inputs by pressing Enter. In that case, the simulation will run on default inputs.")
